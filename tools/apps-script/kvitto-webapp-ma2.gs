...
var KONFIG = {
  '2a': {
    ...
    delmoment: [
      ...
      { omrade: 'Andragradare', namn: 'Pythagoras sats och koordinatgeometri', kort: 'Pythagoras', formId: '' },
      { omrade: 'Andragradare', namn: 'Parentesmultiplikation', kort: 'Parentes', formId: '' },
      { omrade: 'Andragradare', namn: 'Kvadreringsreglerna och konjugatregeln', kort: 'Kvadr./konj.', formId: '' },
      ...
      { omrade: 'Andragradare', namn: 'Andragradsfunktioner problemlösning', kort: 'Problemlösn.', formId: '' },
      ...
      { omrade: 'Ekvationssystem', namn: 'Räta linjens ekvation algebraiskt', kort: 'Linjen alg.', formId: '' },
      { omrade: 'Ekvationssystem', namn: 'Grafisk lösning av ekvationssystem', kort: 'Grafisk lösn.', formId: '' },
      ...
      // Potenser (4) — Del 2
      { omrade: 'Potenser', namn: 'Potenslagar', kort: 'Potenslagar', formId: '' },
      { omrade: 'Potenser', namn: 'Potensekvationer', kort: 'Potensekv.', formId: '' },
      { omrade: 'Potenser', namn: 'Exponentialfunktioner', kort: 'Exp.funk.', formId: '' },
      { omrade: 'Potenser', namn: 'Exponentialekvationer', kort: 'Exp.ekv.', formId: '' },
      // Statistik (3) — Del 2
