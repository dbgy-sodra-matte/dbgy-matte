...
var KONFIG = {
  ...
  '2b': {
    ...
    delmoment: [
      ...
      { omrade: 'Ekvationssystem', namn: 'Funktionsbegreppet f(x)', kort: 'f(x)', formId: '1dsdh3O5sC1IfT8hMyZQfcY6A14ZzWIVcwdewuCUKl3U' },
      { omrade: 'Ekvationssystem', namn: 'Räta linjens ekvation', kort: 'Räta linjen', formId: '19b3s0zj4E-aMGF_9QjE2qrMdpJL6cMuxMNmrGhommx0' },
      { omrade: 'Ekvationssystem', namn: 'Vad är ett ekvationssystem?', kort: 'Ekv.system', formId: '1Ii-UiyhEL97QEkigzlj1rl8oiIyH7ONjE9rDFfu-Sl8' },
      { omrade: 'Ekvationssystem', namn: 'Substitutionsmetoden', kort: 'Substitution', formId: '1qe8yetPRtl6QSklXdKy72k3kUEw6WO3JaJmPYHgor6I' },
      { omrade: 'Ekvationssystem', namn: 'Additionsmetoden', kort: 'Addition', formId: '17XWNnDGd-5nkaLa8LY4hFqTHt1QeHpJVHO7Lwtnizd0' },
      { omrade: 'Ekvationssystem', namn: 'Problemlösning med ekvationssystem', kort: 'Problemlösn.', formId: '1YvVpSeI3p34AIEC8PLfRV_vPs_yeb_ZDijgqN3iKZTg' },
      // Andragradare (9) — Del 1
      { omrade: 'Andragradare', namn: 'Parentesmultiplikation', kort: 'Parentes', formId: '1DVOZ9xanywzJSZH9tNh6yEPeF0s3OoAmQADhV_2zAr8' },
      { omrade: 'Andragradare', namn: 'Kvadreringsreglerna', kort: 'Kvadrering', formId: '1SseByftrDSDXqC0PoKhdfos7fsPmfMBYQ8PXXzvHg3g' },
      { omrade: 'Andragradare', namn: 'Konjugatregeln', kort: 'Konjugat', formId: '1vOZWqGz4d9EBXqwmzW8z0ij0nwur6Hq5b904Gv-qXBQ' },
      { omrade: 'Andragradare', namn: 'Enkla andragradsekvationer', kort: 'Enkla ekv', formId: '18M-Ba0yFoRuTWac8fSgHrnVktnsjdp9ZGzIgUHRKEQs' },
      { omrade: 'Andragradare', namn: 'Nollproduktmetoden', kort: 'Nollprod.', formId: '1eSfvgVPtHTlPx81CurzG6f7YkzXnrt1SyfcGKYMWPhU' },
      { omrade: 'Andragradare', namn: 'pq-formeln', kort: 'pq', formId: '1wPUF8Q_qC7EmPcR7zcghRELWXhuBscNqn1iKhjZVQaU' },
      { omrade: 'Andragradare', namn: 'Andragradsfunktioner grafiskt', kort: 'Grafiskt', formId: '1chEd89TK0Oqc8hIIy1iLvZ8qseU71JHme24PD_5DuRs' },
      { omrade: 'Andragradare', namn: 'Andragradsfunktioner algebraiskt', kort: 'Algebraiskt', formId: '1JmP8Km65pR2HnatlYeYIcOS61LHiHs3E8t6uuyYNrI4' },
      { omrade: 'Andragradare', namn: 'Implikation och ekvivalens', kort: 'Implik./ekv.', formId: '1uE9ooc67qlc9hcSyB3XXfAVtodeRM_VHDGWlxACEDjU' },
      // Logaritmer (4) — Del 2
      { omrade: 'Logaritmer', namn: 'Potenslagar', kort: 'Potenslagar', formId: '1tGiuoUKZvt96Le2zh0yePDUNc_rZZBKNZ1iZKe2gK2s' },
      { omrade: 'Logaritmer', namn: 'Exponentialfunktioner', kort: 'Exp.funk.', formId: '1euMpPDrVBZNwM6t56vsBIcQ8UvJ-0negW8cbSj1FDEY' },
      { omrade: 'Logaritmer', namn: 'Tiologaritmer', kort: 'lg', formId: '1NHwn0t1v8jXE-nW__qNPjerMSbACQci6ODU8c4-8lZw' },
      { omrade: 'Logaritmer', namn: 'Exponentialekvationer', kort: 'Exp.ekv.', formId: '1cVRjj1vXF_MSiKIbv7fTir9hWN6awg9vTnZbN9ol3oM' },
      // Statistik (4) — Del 2
      { omrade: 'Statistik', namn: 'Lägesmått', kort: 'Lägesmått', formId: '1MYx-G9jFbhKIvtcZtLzHXESdx7d03lXNw2yAjCBVdvU' },
      { omrade: 'Statistik', namn: 'Spridningsmått och lådagram', kort: 'Spridning', formId: '1o-f8mE9LBVYCCAMhDWK4q4V3LE44Tf9PW22wpk8stis' },
      { omrade: 'Statistik', namn: 'Normalfördelning', kort: 'Normalförd.', formId: '1Tqs9OCB-h7b_F-yNYKmEYq56gQlsNZs7PI9qRKhDAt4' },
      { omrade: 'Statistik', namn: 'Regression och korrelation', kort: 'Regression', formId: '1uGBNbh4qYxgnJoBPRPuWL16ASaANXwMBYYnmWKqlFn8' },
      // Geometri (6) — Del 2
      { omrade: 'Geometri', namn: 'Vinklar', kort: 'Vinklar', formId: '1D9GGQ_H6PR8IF6z21yj6m3F8RKgLTWxOYs83L2qDR1g' },
      { omrade: 'Geometri', namn: 'Likformighet', kort: 'Likformig.', formId: '1zk8fzPyFYbgh_MAU_VogoSbL2WHkiF5UVMDRmUAWuMs' },
      { omrade: 'Geometri', namn: 'Topptriangel-, transversal- och bisektrissatsen', kort: 'Topptriangel', formId: '1PA3e--eqDzIbJAve4eljwBnWD8kKy2ju7fVzNZrNMcE' },
      { omrade: 'Geometri', namn: 'Randvinkelsatsen', kort: 'Randvinkel', formId: '10Ns4iK84ZfIZu-msiOkNGrVx5E68sb4Is27kOyNC7GY' },
      { omrade: 'Geometri', namn: 'Kordasatsen', kort: 'Korda', formId: '1ZsGeIMxEtEEDt1ZrNesiuYXLDnE6FX485UwUHmFuMjQ' },
      { omrade: 'Geometri', namn: 'Koordinatgeometri', kort: 'Koord.geo.', formId: '1QXH7Msbc_5_aBqzvRmAraVcTS4bz05dwna35KU83r10' },
    ],
  },
};
