/**
 * Ordinarie Ma1a (BF) — kvitto-webbapp + aggregering (FAS B)
 * =========================================================
 * Ma1a = BF. (SaBep läser Ma1b, egen webapp.) Speglar Ma1b-maskineriet exakt.
 *   1. byggSammanstallning() — läser klassens 19 checkpoint-formulär, räknar varje elevs
 ...
 *      renderar trattvyn. En /exec-URL på sajten (/ma1a/mitt-kvitto).
 ...
 *   4. Klistra /exec-URL i src/site.config.ts (kvittoWebAppUrl för ma1a)
 */
...
// De 19 checkpoints, grupperade per moment. Ordning = kursordning.
var CHECKPOINTS = [
  { id: 'cp01', moment: 'Aritmetik', namn: 'Tal, prioritering & bråk' },
  { id: 'cp02', moment: 'Aritmetik', namn: 'Dugga: Aritmetik' },
  { id: 'cp03', moment: 'Algebra', namn: 'Förenkling & faktorisering' },
  { id: 'cp04', moment: 'Algebra', namn: 'Ekvationer' },
  { id: 'cp05', moment: 'Algebra', namn: 'Prov: Algebra' },
  { id: 'cp06', moment: 'Ekonomi', namn: 'Procent & förändringsfaktor' },
  { id: 'cp07', moment: 'Ekonomi', namn: 'Baklänges & upprepad förändring' },
  { id: 'cp08', moment: 'Ekonomi', namn: 'Prov: Ekonomi' },
  { id: 'cp09', moment: 'Funktioner', namn: 'Tabeller, linjära & grafavläsning' },
  { id: 'cp10', moment: 'Funktioner', namn: 'f(x) & linjära modeller' },
  { id: 'cp11', moment: 'Funktioner', namn: 'Prov: Funktioner' },
  { id: 'cp12', moment: 'Talmönster', namn: 'Figurmönster & formler' },
  { id: 'cp13', moment: 'Talmönster', namn: 'Prov: Talmönster' },
  { id: 'cp14', moment: 'Sannolikhet', namn: 'Grunder, oberoende & utan återläggning' },
  { id: 'cp15', moment: 'Sannolikhet', namn: 'Prov: Sannolikhet' },
  { id: 'cp16', moment: 'Statistik', namn: 'Lägesmått, tabeller & diagram' },
  { id: 'cp17', moment: 'Statistik', namn: 'Prov: Statistik' },
  { id: 'cp18', moment: 'Geometri', namn: 'Area, cirkel & Pythagoras' },
  { id: 'cp19', moment: 'Geometri', namn: 'Kursprov: Geometri & hela Ma1a' },
];
var MOMENT_ORDNING = ['Aritmetik', 'Algebra', 'Ekonomi', 'Funktioner', 'Talmönster', 'Sannolikhet', 'Statistik', 'Geometri'];
// Sista momentet = hela kursen avklarad när det tentats av.
var SISTA_MOMENT = MOMENT_ORDNING[MOMENT_ORDNING.length - 1];
...
var KLASSER = [
  {
    ...
    formIds: {
      ...
      cp03: '1cpAa5ghccSVojIS0QiWy5BSWxTnBb9aByhpSXCqWmV8',
      cp04: '1c3UW6TToGierrYLVwcWQgIiXxMlafUZynhmvWJgwxGc',
      cp05: '1QMT_J7G2uLzTj8oBykIKs0EdFHw7X0MlczsCcea4Xps',
      cp06: '17CT2BcAUUvT26gYJJuFMYA7Os7C9r60TMl7UyQh9PsQ',
      cp07: '1KPwvS2J55wN1YKVfHOCu95EnkvjOpJknO4PQM-Ruce0',
      cp08: '1Izjclo_eN4IkNVprAMQrHSpx5PKe5PzLg74bDfOUMK0',
      cp09: '1MJjUA9Y763m7UCysUfpuCjRElCWFJ59qTXr_mmq6-Ho',
      cp10: '1qjjwq-py9dqkRvXOpeHllrcX4UvNBFY8qzk-zo9yqF0',
      cp11: '1gHkAIWfwbLtxgE2KsKZe3OVYIPsZtLC812ImJSmkC5o',
      cp12: '1WJ3r959mjDIOITbbDDxRKWHBSoELFgKmS_fvifGNl6c',
      cp13: '1pZaIhiqv766GBuUWdjfVGMAjv-CZyearKiunkJe_6dY',
      cp14: '1illseDjdtx1fiCbXWosU5-wowmT6ZZ5j5k92M7n-G1s',
      cp15: '120_JNMX7qlrbv-sbOz0JWqyKdzzx5mauRaP28ggVbHA',
      cp16: '1LHnFltVjUNmEkxJ9ZLD_JBK2nG1BS5C08BrovR7MytE',
      cp17: '1uJFtaFpWmcGxszT-vDPuYf0gCeGvsFKLWwqof4Ih0D8',
      cp18: '1Dvo1jzh5QTPiigsC8x-Q_bpTenNSqD5HxtKh8GL80y8',
      cp19: '1teqoYk3MjxMj8QrhjViLkgNkK2IX_RTf8uuE_RBQFcE',
    },
  },
];
...
function beraknaStatus_(momentCount, momentSize, total, nCp, ms, nu, tenta) {
  ...
  if (tenta[SISTA_MOMENT]) return { text: '🎉 Klar med kursen', farg: GRON };
...
'  <div class="eyebrow">📼 Mitt kvitto · Ma1a</div>' +
'  <h1>Dina framsteg</h1>' +
