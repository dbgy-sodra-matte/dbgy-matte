 ...
 *      (.../forms/d/DET_HAR_AR_ID/edit) och klistra in i MALL_ID_2B_DEL2 nedan.
 ...
 *      Om ja — resten stämmer också. Om nej: töm MALL_ID_2B_DEL2, kör om, och
...
const MALL_ID_2B_DEL2 = '';   // <-- klistra in mall-formulärets id här (valfritt)
...
/**
 * OM MALL_ID_2B_DEL2 lämnas tomt — gör detta per formulär efteråt:
