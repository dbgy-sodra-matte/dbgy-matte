...
bank:
  - question: "I y = 3x + 2, vad är m?"
    answer: "2"
    solution: |
      m är talet utan x, alltså startvärdet där linjen skär y-axeln.
      Svar: **m = 2**
  - question: "I y = 3x + 2, vad är k?"
    answer: "3"
    solution: |
      k är talet framför x, alltså lutningen.
      Svar: **k = 3**
  - question: "I y = 5x − 1, vad är startvärdet?"
    answer: ["−1", "-1"]
    solution: |
      Startvärdet är m, talet utan x. Här står ett minus framför ettan.
      Svar: **m = −1**
  - question: "y = 2x + 7. Vad är y när x = 0?"
    answer: "7"
    solution: |
      x = 0 gör att 2x försvinner, kvar blir bara m.
      y = 2 · 0 + 7 = **7**
