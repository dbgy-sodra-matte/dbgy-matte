...
bank:
  - question: "Lös: x + 5 = 12"
    answer: "x = 7"
    solution: |
      Femman ska bort från vänsterledet, så dra bort 5 i båda leden.
      x = 12 − 5 = **7**
  - question: "Lös: 6x = 42"
    answer: "x = 7"
    solution: |
      x är multiplicerad med 6, så dela båda leden med 6.
      x = 42 / 6 = **7**
  - question: "Lös: 2x + 4 = 10"
    answer: "x = 3"
    solution: |
      Ta bort det som står ensamt först: dra bort 4 i båda leden.
      2x = 6.
      Dela med 2: **x = 3**
  - question: "Lös: x − 2 = 9"
    answer: "x = 11"
    solution: |
      Lägg till 2 i båda leden.
      x = 9 + 2 = **11**
