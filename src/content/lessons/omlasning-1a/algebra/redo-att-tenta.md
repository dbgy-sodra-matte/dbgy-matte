---
slug: "omlasning-1a/algebra/redo-att-tenta"
...
exercises:
  E:
    - equation: "Förenkla: 8x + 3 − 2x + 4"
      hint1: "Samla x-termer för sig, tal för sig."
      answer: ["6x + 7", "7 + 6x"]
      solution: |
        8x − 2x = 6x och 3 + 4 = 7 → **6x + 7**

        → Tränas i delmoment 1: **Förenkling**

    - equation: "Förenkla: 7a − (2a + 3)"
      hint1: "Minus framför parentesen byter tecken på allt inuti."
      answer: ["5a − 3", "5a - 3"]
      solution: |
        7a − (2a + 3) = 7a − 2a − 3 = **5a − 3**

        → Tränas i delmoment 1: **Förenkling**

    - equation: "Lös: 3x + 5 = 20"
      hint1: "Subtrahera 5, sedan dela med 3."
      answer: ["5"]
      solution: |
        3x + 5 = 20 → 3x = 15 → **x = 5**

        Kontroll: 3 · 5 + 5 = 20 ✓
        → Tränas i delmoment 2: **Grundläggande ekvationer**

    - equation: "Lös: 6x − 2 = 4x + 8"
      hint1: "Samla x på en sida: subtrahera 4x i båda leden."
      answer: ["5"]
      solution: |
        6x − 2 = 4x + 8
        2x − 2 = 8
        ...
        **x = 5**
        ...
        Kontroll: 6 · 5 − 2 = 28 och 4 · 5 + 8 = 28 ✓
        → Tränas i delmoment 3: **Ekvation med x i båda led**

    - equation: "Faktorisera: 8x + 12"
      hint1: "Största talet som delar både 8 och 12?"
    ...
    - equation: "Lös: 2(x + 3) = 14"
      ...
      solution: |
        ...
        Kontroll: 2 · (4 + 3) = 14 ✓
        → Tränas i delmoment 5: **Ekvationer med parenteser**

    - equation: "Lös: x/4 = 6"
      hint1: "Multiplicera båda leden med 4."
      answer: ["24"]
      solution: |
        x/4 = 6 → **x = 24**

        Kontroll: 24/4 = 6 ✓
        → Tränas i delmoment 6: **Ekvationer med nämnare**

    - equation: "O = 2a + 2b. Beräkna O när a = 5 och b = 3."
      hint1: "Sätt in talen: 2 · 5 + 2 · 3. Gånger före plus."
      answer: ["16", "O = 16"]
      solution: |
        O = 2 · 5 + 2 · 3 = 10 + 6 = **16**

        → Tränas i delmoment 7: **Formler**

    - equation: "En cykeluthyrning kostar 50 kr i startavgift plus 20 kr per timme. Skriv en formel för kostnaden efter x timmar."
      hint1: "Fast del (en gång) + rörlig del (gångas med x)."
      answer: ["50 + 20x", "20x + 50", "K = 50 + 20x"]
      solution: |
        **50 + 20x**
...
next_lesson_title: "Förändringsfaktor"
---
